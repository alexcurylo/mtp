...
extension XCUIElementTypeQueryProvider {
    ...
    func printList(of type: XCUIElement.ElementType) {
        let list = query(type: type)
        print("list of \(type) (\(list.count)):\n\(list.debugDescription)")
    }
...
extension XCUIElement.ElementType: CustomStringConvertible {
    ...
    public var description: String {
        ...
        case .table: return "tables"
        case .tableColumn: return "tableColumns"
        case .tableRow: return "tableRows"
        case .textField: return "textFields"
        case .textView: return "textViews"
        case .timeline: return "timelines"
        case .toggle: return "toggles"
        ...
        @unknown default:
            fatalError("handle new ElementType query: \(self)")
        }
    }
}
