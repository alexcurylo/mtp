...
final class SimpleNetworkIntegration: NSObject,
                                      AXNetworkIntegrationProtocol,
                                      URLSessionWrapperDelegate {

    fileprivate var urlSessionWrapper = URLSessionWrapper()
    weak var delegate: AXNetworkIntegrationDelegate?

    fileprivate var dataTasks = NSMapTable < AXPhotoProtocol,
    ...
    // MARK: - URLSessionWrapperDelegate

    fileprivate func urlSessionWrapper(_ urlSessionWrapper: URLSessionWrapper,
...
private class URLSessionWrapper: NSObject, URLSessionDataDelegate, URLSessionTaskDelegate {

    weak var delegate: URLSessionWrapperDelegate?
    ...
    func urlSession(_ session: URLSession, dataTask: URLSessionDataTask, didReceive data: Data) {
        ...
        self.delegate?.urlSessionWrapper(
            self,
            dataTask: dataTask,
...
private protocol URLSessionWrapperDelegate: NSObjectProtocol, AnyObject {

    func urlSessionWrapper(_ urlSessionWrapper: URLSessionWrapper,
                           dataTask: URLSessionDataTask,
                           didUpdateProgress progress: CGFloat)
    func urlSessionWrapper(_ urlSessionWrapper: URLSessionWrapper,
                           task: URLSessionTask,
