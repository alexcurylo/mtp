...
// migrated from https://github.com/alexhillc/AXStateButton
...
@property (nonatomic, nonnull) NSDictionary<NSString *, NSMutableDictionary<NSNumber *, id> *> *stateDictionary;

@end

@implementation AXStateButton

@synthesize animateControlStateChanges = _animateControlStateChanges;
@synthesize controlStateAnimationDuration = _controlStateAnimationDuration;
@synthesize controlStateAnimationTimingFunction = _controlStateAnimationTimingFunction;
...
- (NSDictionary<NSString *, id> *)tintColorStateChangesForState:(UIControlState)controlState {
    ...
    AXStateBlock block = ^() {
        ...
        strongSelf.tintColor = [strongSelf tintColorForState:controlState];
    };
...
- (NSDictionary<NSString *, id> *)backgroundColorStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.layer.backgroundColor = [strongSelf backgroundColorForState:controlState].CGColor;
        };
...
- (NSDictionary<NSString *, id> *)alphaStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.layer.opacity = (float)toValue;
        };
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.layer.opacity = (float)[strongSelf alphaForState:controlState];
        };
...
- (NSDictionary<NSString *, id> *)titleAlphaStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.titleLabel.layer.opacity = (float)toValue;
        };
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.titleLabel.layer.opacity = (float)[strongSelf titleAlphaForState:controlState];
        };
...
- (NSDictionary<NSString *, id> *)imageAlphaStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.imageView.layer.opacity = (float)toValue;
        };
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.imageView.layer.opacity = (float)[strongSelf imageAlphaForState:controlState];
        };
...
- (NSDictionary<NSString *, id> *)cornerRadiusStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.layer.cornerRadius = [strongSelf cornerRadiusForState:controlState];
        };
...
- (NSDictionary<NSString *, id> *)borderColorStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.layer.borderColor = [strongSelf borderColorForState:controlState].CGColor;
        };
...
- (NSDictionary<NSString *, id> *)borderWidthStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.layer.borderWidth = [strongSelf borderWidthForState:controlState];
        };
...
- (NSDictionary<NSString *, id> *)transformRotationXStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            [strongSelf.layer setValue:@([strongSelf transformRotationXForState:controlState]) forKeyPath:xRotationKeyPath];
        };
...
- (NSDictionary<NSString *, id> *)transformRotationYStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            [strongSelf.layer setValue:@([strongSelf transformRotationYForState:controlState]) forKeyPath:yRotationKeyPath];
        };
...
- (NSDictionary<NSString *, id> *)transformRotationZStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            [strongSelf.layer setValue:@([strongSelf transformRotationZForState:controlState]) forKeyPath:zRotationKeyPath];
        };
...
- (NSDictionary<NSString *, id> *)transformScaleStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            [strongSelf.layer setValue:@([strongSelf transformScaleForState:controlState]) forKeyPath:scaleKeyPath];
        };
...
- (NSDictionary<NSString *, id> *)shadowColorStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.layer.shadowColor = [strongSelf shadowColorForState:controlState].CGColor;
        };
...
- (NSDictionary<NSString *, id> *)shadowOpacityStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.layer.shadowOpacity = (float)toValue;
        };
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.layer.shadowOpacity = (float)[strongSelf shadowOpacityForState:controlState];
        };
...
- (NSDictionary<NSString *, id> *)shadowOffsetStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.layer.shadowOffset = [strongSelf shadowOffsetForState:controlState];
        };
...
- (NSDictionary<NSString *, id> *)shadowRadiusStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.layer.shadowRadius = [strongSelf shadowRadiusForState:controlState];
        };
...
- (NSDictionary<NSString *, id> *)shadowPathStateChangesForState:(UIControlState)controlState {
    ...
    if (self.animateControlStateChanges) {
        ...
        AXStateBlock block = ^() {
            typeof(self) strongSelf = weakSelf;
            strongSelf.layer.shadowPath = [strongSelf shadowPathForState:controlState].CGPath;
        };
