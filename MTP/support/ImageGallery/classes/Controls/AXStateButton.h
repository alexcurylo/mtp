 ...
 */
@property (nonatomic) BOOL animateControlStateChanges;

/**
 The duration of the transition animation. Defaults to `0.2`.
 */
@property (nonatomic) NSTimeInterval controlStateAnimationDuration;
 ...
 */
@property (nonatomic, nonnull) CAMediaTimingFunction *controlStateAnimationTimingFunction;
